...
void GenRandomGadget1InstanceWitness(Gadget::PP &pp, Gadget::Instance &instance, Gadget::Witness_type1 &witness)
{
    ...
    TwistedElGamal::Enc(enc_pp, instance.pk, witness.m, witness.r, instance.ct); 
...
void GenRandomGadget2InstanceWitness(Gadget::PP &pp, Gadget::Instance &instance, Gadget::Witness_type2 &witness)
{
    ...
    TwistedElGamal::KeyGen(enc_pp, keypair); 

    BigInt m = GenRandomBigIntLessThan(bn_range_size);
    TwistedElGamal::CT ct; 
    TwistedElGamal::Enc(enc_pp, keypair.pk, m, ct);  
...
void test_gadget1(BigInt &LEFT_BOUND, BigInt &RIGHT_BOUND, size_t &RANGE_LEN, size_t &AGG_NUM, size_t &DEC_THREAD_NUM, size_t &TRADEOFF_NUM)
{
    PrintSplitLine('-'); 
...
void test_gadget2(BigInt &LEFT_BOUND, BigInt &RIGHT_BOUND, 
                  size_t &RANGE_LEN, size_t &AGG_NUM, size_t &DEC_THREAD_NUM, size_t &TRADEOFF_NUM)
{
    PrintSplitLine('-'); 
...
{ 
    ...
    test_gadget1(LEFT_BOUND, RIGHT_BOUND, RANGE_LEN, AGG_NUM, DEC_THREAD_NUM, TRADEOFF_NUM); 
    test_gadget2(LEFT_BOUND, RIGHT_BOUND, RANGE_LEN, AGG_NUM, DEC_THREAD_NUM, TRADEOFF_NUM); 
